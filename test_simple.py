...
def parse_args():
    ...
    parser.add_argument('--image_path', type=str, help='path to a test image or folder of images')
    parser.add_argument('--model_path', type=str, help='path to the test model')
